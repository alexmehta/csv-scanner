...
public class countries {
    ...
    public void listExporters(org.apache.commons.csv.CSVParser parser, String exportOfInterest){
    ...
    public void CountryInfo(org.apache.commons.csv.CSVParser parser, String countryOfInterest) {
        for (org.apache.commons.csv.CSVRecord record : parser) {
            String country = record.get("Country");
            if (country.contains(countryOfInterest)) {
                String exportz = record.get("Exports");
                String money = record.get("Value (dollars)");
                String output = String.format("%s: %s: %s", country, exportz, money);
    ...
    public static void main(String[] args) {
        countries exports = new countries();
        FileResource fr = new FileResource();
        org.apache.commons.csv.CSVParser parser = fr.getCSVParser();

        exports.listExporters(parser,"coffee");
        exports.CountryInfo(parser,"Germany");
    }
}
